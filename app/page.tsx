            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Run the device scanner to automatically find all Modbus
                  devices on your network. Add them to your device list with
                  custom names.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Select a device, configure register type and address range,
                  then start monitoring. Track multiple devices simultaneously.
                </p>
              </div>
